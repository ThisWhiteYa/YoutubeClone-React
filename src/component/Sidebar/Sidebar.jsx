...
function Sidebar() {
  ...
  return (
    <div className="sidebar-container">
      ...
      <ul className="section">
        <li className="item" style={{ display: "flex", alignItems: "end" }}>
          คุณ &nbsp; <SlArrowRight style={{ width: "0.65em" }} />
        </li>
        <li className="item">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <li className="item">
          ...
          <span>วิดีโอที่ชอบ</span>
        </li>
      </ul>
      <ul className="section">
        <li className="sub-title">การติดตาม</li>
        <li className="item">
          <div className="follow">
            <div className="icon">
              <CgProfile style={{ height: "1.5em", width: "1.5em" }} />
            </div>
            <div className="name">9arm</div>
      ...
      <ul className="section">
        <li className="sub-title">สำรวจ</li>
        <li className="item">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            enable-background="new 0 0 24 24"
      ...
      <ul className="section">
        <li className="sub-title">เพิ่มเติมจาก YouTube</li>
        <li className="item">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
